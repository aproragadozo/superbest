    ...
    return {
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.selectResult = function(result) {
				...
				// create and append a link to download the selected font as a Google Font
				$("<link/>")
					.attr({rel: "stylesheet",
							type: "text/css",
				...
				// call the toggler function so that the letters move whenever a new font family is selected
				$scope.toggler();
            ...
            elem.on("keyup", function (event) {
                if(event.which === 40) {
                    ...
                    if ($scope.results && $scope.currentIndex >= 0 && $scope.currentIndex < $scope.results.length) {
						// this is where you need to pass in the proper event object as second argument...
